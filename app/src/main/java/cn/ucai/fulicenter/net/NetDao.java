...
public class NetDao {
    ...
    public static void deleteCollect(Context context, String username,int pageId, OkHttpUtils.OnCompleteListener<MessageBean>listener){
        OkHttpUtils<MessageBean> utils = new OkHttpUtils<>(context);
        utils.setRequestUrl(I.REQUEST_DELETE_COLLECT)
                .addParam(I.Collect.USER_NAME,username)
                .addParam(I.Collect.GOODS_ID,String.valueOf(pageId))
                .targetClass(MessageBean.class)
                .execute(listener);
    }
